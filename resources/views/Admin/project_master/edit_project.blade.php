...
<div class="main_card">
    <div class="neuphormic_shadow" style="padding:10px"><a class="black_anchor" href="{{ url('project/showdata') }}">
            ...
            <span class="bold_text" style="font-size: 18px;">EDIT PROJECT</span></a>
                            ...
                            <div class="col-sm-6 col-xs-12 col-md-8">
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12 col-md-6">
                                        <input type="hidden" id="PROJECT_ID" value="{{ $allprodata->PROJECT_ID }}">
                                        <div class="colll-3 input-effect">
                                            <input class="effect-16" type="text" id="PROJECT_NAME"  placeholder="" style="clear:both"  value="{{ $allprodata->PROJECT_NAME }}">
                                    ...
                                    <div class="col-sm-12 col-xs-12 col-md-6">
                                        <div class="colll-3 input-effect">
                                            <input class="effect-16" type="text" id="PROJECT_DESCRIPTION" value="{{ $allprodata->PROJECT_DESCRIPTION }}" placeholder="" style="clear:both">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12 col-md-6">
                                        <div class="colll-3 input-effect">
                                            <input class="effect-16" type="text" id="PROJECT_TARGET_HR" value="{{ $allprodata->PROJECT_TARGET_HR }}" placeholder="" style="clear:both">
                                    ...
                                    <div class="col-sm-12 col-xs-12 col-md-6">
                                        <div class="colll-3 input-effect">
                                            <input class="effect-16" type="text" id="PROJECT_COST" value="{{ $allprodata->PROJECT_COST }}" placeholder="" style="clear:both">
