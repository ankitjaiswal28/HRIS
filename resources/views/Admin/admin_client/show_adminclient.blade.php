        ...
        <div class="main_card">
            <div class="neuphormic_shadow fst_card">
                <div class="fst_card_cntnt">
                    <h3 class="h3_header_prt" style=""><a class="white_anchor" href="{{ url('/Superadmin/dashboard') }}"><i class="typcn typcn-home-outline" aria-hidden="true"></i></a> | <label class="ralway_font">Client's</label>
                    </h3>
                </div>
                <div style="float:right;">
                    <a href="{{ url('/show_add_client') }}" class="btnn"><i class="fa fa-plus" style="padding-right: 10px;" aria-hidden="true"></i>ADD CLIENT</a>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('#example').DataTable({
        ...
        columns: [
            ...
            { data: 'CLIENT_PREFIX', name: 'CLIENT_PREFIX' },
