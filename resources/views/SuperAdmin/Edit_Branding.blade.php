...
<div class="flip-card-3D-wrapper width35">
    <div class="columns">
        <div class="inner-column" id="flip-card">
            <div class="flip-card-front" style="padding-top: 10px;">
                <div class="">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 class="left_border font_grey" style="float: left;">Edit Branding</h1>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="padding_20" style="padding: 0px 35px;">
                        <div class="row">
                            <div class=" col-sm-12 col-xs-12 col-md-12">
                                <div class="colll-3">
                                    <input type="text" id="picker-elements-colour" name="primary_color"
                                        class="picker effect-16" value="1c2841" style="">
                                    <label class="without_focus">Primary Color</label>
                                    <span class="focus-border"></span>
                                </div>
                                <div class="colll-3 input-effect">
                                    <input type="text" id="picker-elements-colour1" name="secondary_color"
                                        class="picker effect-16 " value="1c2841" style="">
                                    <label>Secondary Color</label>
                                    <span class="focus-border"></span>
                                </div>
                                <div class="colll-3 input-effect">
                                    <input type="text" id="picker-elements-colour2" name="tertiary_color"
                                        class="picker effect-16 " value="1c2841" style="">
                                ...
                                <div class="colll-3 input-effect">
                                    <label class="without_focus">Title Logo</label>
                                    <br>
                                    <input type='file' id="title_logo" accept=".png, .jpg, .jpeg"
                                        style="float: left;" />
                                </div>
                                <div class="colll-3 input-effect">
                                    <label class="without_focus">Main Logo</label>
                                    <br>
                                    <input type='file' id="main_logo" accept=".png, .jpg, .jpeg" style="float: left;" />
                                </div>
                            </div>
                        </div>
