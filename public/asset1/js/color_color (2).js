        ...
        var
            ...
            downHue = function(ev) {
                ...
                change.apply(
                    ...
                    .get(0), [current.cal.data('colpick').livePreview]
                );
                return false;
            },
            moveHue = function(ev) {
 ...
 *********************************************/
var newColorColorPickText = $('.Center-Block h4, .Center-Block p');
...
function chooseColourScheme(chooseColor) {
    ...
    newColorColorPickText.css('color', '#fff');
    $('#picker-elements-colour').colpickSetColor(newColor, true);
    if (!(/Trident\/7\./).test(navigator.userAgent)) {
