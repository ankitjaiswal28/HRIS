...
<div class="new-wrapper">
    <div id="main">
        ...
        font-size: 18px;">Add Attendence</span></a><i class="fa fa-close" aria-hidden="true"
                ...
                <div class="inner-column" id="flip-card">
                    <div class="flip-card-front" style="padding-top: 10px;">
                        <div class="">
                            <div class="row">
                                <div class="col-md-10">
                                    <h1 class="left_border font_grey" style="float: left;">Add Attendence</h1>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12 col-md-12">
                                        <select class="js-select2" id="allusers">
                                            <option value = "" >List of User</option>
                                            <?php
            ...
            if (alluser != '') {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(response =='Done') {
                            alert('Attendence Added Sucessfuly');
