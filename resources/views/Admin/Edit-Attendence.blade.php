                            ...
                            <div class="padding_20" style="padding: 0px 35px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-sm-12 col-xs-12 col-md-12">
                                        <label for="" class="grey">IN DATE</label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="datepicker" style="width: 100%;" class="grey">IN TIME
                                            <input type="text" class="form-control" id="InitialTime" value= "{{$responese->in_time}}"style="font-size: 20px; border-bottom: 1px solid #cecece !important;">
                                        </label>
                                    </div>
                                </div>
                                {{-- </div> --}}
            ...
            // if (alluser != '') {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(response =='Done') {
                            alert('In Time Updated Sucessfuly');
