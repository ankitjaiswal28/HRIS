...
<div class="new-wrapper">
        ...
        <div class="main_card">
            <div class="neuphormic_shadow" style="height: 55px;padding: 15px 10px;position: relative;">
                <div style="float:left;">
                    <span id="checkout"> <a class="checkout_btn" id="popup-btnn"
                            style="cursor: pointer;color: white;">Check Out
    ...
    <span id="sw_ms">00</span> --}}
                ...
                <div style="float:right;">
                    <a href="/applyleave" class="btnn"><img src="/asset/css/zondicons/zondicons/date-add.svg"
                            class="edit_icon" style="-webkit-filter: invert(1);">Apply Leave</a> <a
                        href="/timesheet/showdata" class="btnn a_btn"><img src="/asset/css/zondicons/zondicons/time.svg"
                            class="edit_icon" style="-webkit-filter: invert(1);">Timesheet</a>
                </div>
            </div>
        </div>
        {{-- <div class="main_card">
            ...
            <div class="row no_left_margin">
                <div class="col-md-3 nopadding no_padding_left">
                    <div class="widget">
                        <div class="widget-header dcard neuphormic_shadow">
                            <a href="/User_Creation">
                                <div class="card_hdr"><span class="round_dot_1"></span><span
                                        class="round_dot_2"></span>Employee Details
                                ...
                                <div class="bg-style">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 offset-md-2" style="margin-top: 30px;">
                                            <div class="counter" data-cp-percentage="{{$percentage}}"
                ...
                <div class="col-md-3 nopadding no_padding_left">
                    <div class="widget">
                        <div class="widget-header dcard neuphormic_shadow">
                            <div class="card_hdr"><span class="round_dot_1"></span><span
                                    class="round_dot_2"></span>Timesheet
                                <span class="d_count">25</span>
                            </div>
                                ...
                                <table id="example" class="table table-hover" style="width:100%">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="grey_font no_border icon_show" style="float: right;"><a
                                                    href=""><img src="/asset/css/zondicons/zondicons/edit-pencil.svg"
                                                        class="edit_icon" alt=""></a><a href=""><img
                                                        src="/asset/css/zondicons/zondicons/close.svg"
                                                        class="cross_icon" alt=""></a>
                                            </td>
                                        </tr>
                                        <tr>
                ...
                <div class="col-md-3 nopadding no_padding_left">
                    <div class="widget">
                        <div class="widget-header dcard neuphormic_shadow">
                            <div class="card_hdr"><span class="round_dot_1"></span><span class="round_dot_2"></span>New
                                Hire
                                <span class="d_count">25</span>
                            </div>
                            <div class="divcard_hdr">
