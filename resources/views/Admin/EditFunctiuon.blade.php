...
<div class="main_card">
    <div class="neuphormic_shadow" style="padding:10px"><a class="black_anchor" href="{{ url('/Superadmin/role') }}"><i
        ...
        font-size: 18px;">Edit Function</span></a><i class="fa fa-close" aria-hidden="true"
        ...
        <div class="inner-column" id="flip-card">
            <div class="flip-card-front" style="padding-top: 10px;">
                <div class="">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 class="left_border font_grey" style="float: left;">Edit Function</h1>
                        </div>
                        <div class="col-md-2">
                    ...
                    <input type="hidden" id ="functionId" value ={{$getFunction->FUNCTION_ID}}>
                            ...
                            <div class=" col-sm-12 col-xs-12 col-md-12">
                                <div class="colll-3 input-effect">
                                    <input class="effect-16" type="text" placeholder="" style="clear:both"
                                        id="functionname" data-parsley-trigger="blur" required="" value = {{$getFunction->FUNCTION_NAME}}>
                                    <label>Function  Name</label>
                                    <span class="focus-border"></span>
                                </div>
                                <div class="colll-3 input-effect">
                                <select class="js-example-basic-multiple" name="departments[]"  id= "departments" multiple="multiple" style="height: calc(3.25rem + 2px);border: 1px solid #cecece !important;padding: 15px !important;" data-parsley-trigger="blur" required="" >

                                   <?php
                                     $length = count($deparments);
                                     $assinDepartment = explode(",", $getFunction->DEPARTMENT_ID);
                                    for($j = 0 ; $j < $length; $j++) {
                                        ?>

                                        <option value={{$deparments[$j]->DEPARTMENT_ID}} <?php if (in_array($deparments[$j]->DEPARTMENT_ID, $assinDepartment))
                                        {
                                            echo 'selected';
                                        }
                                        ?>
               ...
               data: {
                    ...
                    success: function(data) {
                        console.log('Data', data)
                         ...
                         if(response == 'Done') {
                             alert('Function  Updated  Sucessfuly');
