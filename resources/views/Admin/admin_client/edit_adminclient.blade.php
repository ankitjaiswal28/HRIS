                                ...
                                <div class="row">
                                    ...
                                    <div class=" col-sm-12 col-xs-12 col-md-12">
                                        <div class="colll-3 input-effect">
                                            <input type="hidden" id="ADMIN_CLIENT_ID" value="{{ $allclientdata->ADMIN_CLIENT_ID }}">
                                            <input class="effect-16" type="text" placeholder="" style="clear:both" id="CLIENT_NAME" data-parsley-trigger="blur" value="{{ $allclientdata->CLIENT_NAME }}" required="">
                                    ...
                                    <div class=" col-sm-12 col-xs-12 col-md-12">
                                        <div class="colll-3 input-effect">
                                            <input class="effect-16" type="text" placeholder="" style="clear:both" id="CLIENT_PREFIX" data-parsley-trigger="blur" value="{{ $allclientdata->CLIENT_PREFIX }}" required="">
...
<script>
    $(document).ready(function() {
        $("#submit_form").click(function(e) {
            ...
            var ADMIN_CLIENT_ID = $("#ADMIN_CLIENT_ID").val();
