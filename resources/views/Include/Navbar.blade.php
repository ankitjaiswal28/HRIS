    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
                <a class="nav-link" href="/Superadmin/dashboard">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Superadmin/Client">Client</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Superadmin/role">Role</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Superadmin/module">Module</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/Superadmin/User">User</a>
            </li>
            {{-- <li class="dropdown">
                ...
                <div class="dropdown-menu profile_open animated fadeInUp not_show "
                    ...
                    <div class="profile_div">
                        <div class="hris_prfile">
                            ...
                            <div>
                                <span style="float:left"><a href="/User/my_account" class="btnn">My
                                        Account</a></span>
                                <span style="float:right"><a href="" class="btnn">Logout</a></span>
                            </div><br>
                        </div>
                    </div>
                </div>
