...
<div class="main_card">
    <div class="neuphormic_shadow" style="padding:10px"><a class="black_anchor" href="{{ url('/Superadmin/role') }}"><i
        ...
        font-size: 18px;">All Designation</span></a><i class="fa fa-close" aria-hidden="true"
        ...
        <div class="inner-column" id="flip-card">
            <div class="flip-card-front" style="padding-top: 10px;">
                <div class="">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 class="left_border font_grey" style="float: left;">Add Designations</h1>
                        </div>
                        <div class="col-md-2">
                            ...
                            <div class=" col-sm-12 col-xs-12 col-md-12">
                                <div class="colll-3 input-effect">
                                    <input class="effect-16" type="text" placeholder="" style="clear:both"
                                        id="designation_name" data-parsley-trigger="blur" required="">
               ...
               data: {
                    ...
                    success: function(data) {
                        console.log('Data', data)
                         ...
                         if(response == 'Done') {
                             alert('Designation Added Sucessfuly');
