        ...
        <div class="inner-column" id="flip-card">
            <div class="flip-card-front" style="padding-top: 10px;">
                <div class="">
                    <div class="row">
                        <div class="col-md-10">
                            <h1 class="left_border font_grey" style="float: left;">Add Module</h1>
                        </div>
                        <div class="col-md-2">
                    ...
                    <form action="#" name="module_creation" id="module_creation" class="form_class" data-parsley-validate autocomplete="off">
                        <div class="row">
                            <div class=" col-sm-12 col-xs-12 col-md-12">
                                <div class="colll-3 input-effect">
                                    <input class="effect-16" type="text" placeholder="" style="clear:both"
                                        id="module_name" name="module_name" data-parsley-trigger="blur" required="">
                            ...
                            <div class=" col-sm-12 col-xs-12 col-md-12">
                                <div class="colll-3 input-effect">
                                    <input class="effect-16" type="text" placeholder="" style="clear:both"
                                        id="url" name="url" data-parsley-trigger="blur" required="">
                                    <label>URL</label>
                                    <span class="focus-border"></span>
                                </div>
                            </div>
    ...
    $(document).ready(function(){
        ...
        $('#submit_form').click(function(event) {
            ...
            if (isValid) {
                    ...
                    success: function(data) {
                       ...
                       //  return;
                        var response = data.trim();
                         if(response == 'Done'){
                             alert('Module Created Sucesfuly')
                ...
                console.log("module_name :" + module_name +  ' Url :' + url);
            }
        });
