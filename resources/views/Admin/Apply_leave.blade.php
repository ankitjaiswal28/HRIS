...
<div class="main_card">
    <div class="neuphormic_shadow" style="padding:10px"><a class="black_anchor" href="{{ url('/') }}"><i class="fa fa-chevron-left" aria-hidden="true"
...
<script type="text/javascript">
    $(document).ready(function(){
      $("#submit_form").click(function(){
          ...
          var start_end_date = enddate;

          console.log("leave_type :",leave_type);
          console.log("reason :",reason);
          console.log("start_leave_date :",start_leave_date);
          console.log("start_end_date :",start_end_date);
        });
    });
</script>
@endsection
